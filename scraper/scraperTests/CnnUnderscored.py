# file: CnnUnderscored.py
# Extracts CNN underscored articles, prints the soupified html 
import requests
import time
import warnings
import sys
...
class CnnUnderscored(WebScraper):
        ...
        for tag in self.tags:
            ...
            for link in links_set:
                ...
                if href.startswith("/") == False:
                    continue
                if href.startswith("/cnn-underscored") == False:
                    continue
    ...
    def create_article(self, tag, url):
        ...
        try:
            ...
            # Print soup if title can not be found
            # Usually it turns out it's a Captcha page
